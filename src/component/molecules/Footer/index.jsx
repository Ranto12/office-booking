...
const index = () => {
  return (
    <div className='mx-32 h-auto my-5   text-center py-5'>
        <div className='w-full md:flex px-5'>
            ...
            <div className='md:w-1/3 w-full md:flex md:text-left'>
                <div className='text-base font-medium gap-y-20 w-full md:w-1/2 ' >
                    <p className='font-semibold text-2xl  mb-5'>SewaKantor</p>
                    <p>Home</p>
                    <p>Kantor</p>
                    <p>Team</p>
                </div>
                <div className='text-base my-5 md:mt-0 font-medium gap-y-20 w-full md:w-1/2 ' >
    ...
    // <div className='mx-32 h-auto my-5  bg-white text-center py-5'>
    ...
    //         </div>
    //         <div className='flex gap-3 justify-center my-4 mb-10'>
    //             <img src={Facebook} alt="facobook" />
    //             <img src={Instagram} alt="Instagram" />
    //             <img src={Linkedin} alt="Linkedin" />
    //         </div>
    //         </div>
    //         <div className='text-base font-medium gap-y-20' >
    //             <p className='font-semibold text-2xl  mb-5'>SewaKantor</p>
    //             <p>Home</p>
    //             <p>Kantor</p>
    //             <p>Team</p>
    //         </div>
    //         <div className='text-base mt-5 font-medium gap-y-20' >
    //             <p className='font-semibold text-2xl  mb-5'>Bantuan</p>
    //             <p>Syarat & Ketentuan</p>
    //             <p>Kebijakan Privasi</p>
    //             <p>About Us</p>
